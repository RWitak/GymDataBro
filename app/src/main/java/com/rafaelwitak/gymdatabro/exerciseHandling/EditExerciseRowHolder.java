...
//import com.rafaelwitak.gymdatabro.exerciseHandling.editExerciseRows.PrRow;

public class EditExerciseRowHolder extends EditRowHolder {
    private final Exercise exercise;

    private final NameRow nameRow;
//    private final PrRow prRow;
...
//        this.prRow = new PrRow(binding);
    ...
    private Exercise setupExerciseFromRowsInputs(Exercise exercise) {
        ...
        // exercise.pr = prRow.getEditTextValueAsFloat();
    ...
    public void setupRowTexts(Exercise exercise) {
        ...
        // nameRow.setPreFilledText(exercise.pr);
